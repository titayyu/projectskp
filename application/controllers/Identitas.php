    ...
    public function update($id){
        ...
        if ($row) {
            $data = array(
				...
				'alamat_website' => set_value('alamat', $row->alamat_website),
				'email_website' => set_value('email', $row->email_website),
				'telp_website' => set_value('telp', $row->telp_website),
			...
			if(!empty($_FILES['favicon']['name'])){	
				...
				if ($this->upload->do_upload('favicon')){					
					...
					$data = array(
								...
								'telp_website' => $this->input->post('telp_website',TRUE),
