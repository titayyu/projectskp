...
class Persetujuanlkp extends CI_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model('Persetujuanlkp_model'); // Memanggil Model_model yang terdapat pada models
	...
	public function index()
	{
		...
		$this->load->view('persetujuanlkp/Persetujuanlkp_list');
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			$this->load->view('Persetujuanlkp/Persetujuanlkp_read', $data); // Menampilkan halaman detail model
	...
	public function create()
	{
		...
		$data = array(
			'button' => 'Create',
			'action' => site_url('Persetujuanlkp/create_action'),
			'back'   => site_url('Persetujuanlkp'),
		...
		$this->load->view('header', $dataAdm); // Menampilkan bagian header dan object data users 
		$this->load->view('Persetujuanlkp/Persetujuanlkp_form', $data); // Menampilkan halaman form model
		$this->load->view('footer'); // Menampilkan bagian footer
	}
	...
	public function create_action()
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			if (!empty($_FILES['photo']['name'])) {
				...
				redirect(site_url('Persetujuanlkp'));
			}
	...
	public function update($id)
	{
		...
		if ($row) {
			$data = array(
				'button' => 'Update',
				'action' => site_url('Persetujuanlkp/update_action'),
				'back'   => site_url('Persetujuanlkp'),
			...
			$this->load->view('header', $dataAdm); // Menampilkan bagian header dan object data users 
			$this->load->view('Persetujuanlkp/Persetujuanlkp_form', $data); // Menampilkan form model
			$this->load->view('footer'); // Menampilkan bagian footer
		} else {
			$this->session->set_flashdata('message', 'Record Not Found');
			redirect(site_url('model'));
