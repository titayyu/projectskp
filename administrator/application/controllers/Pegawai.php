...
class Pegawai extends CI_Controller //dilihat dari sini letaknya di folder controller
{
	// Konstruktor			
	function __construct()
	{
		parent::__construct();
		$this->load->model('Pegawai_model'); // Memanggil Pelanggan_model yang terdapat pada models
	...
	public function index()
	{
		...
		$this->load->view('pegawai/pegawai_list'); // Menampilkan halaman utama pelanggan
	...
	public function json()
	{
		...
		echo $this->Pegawai_model->json($rowAdm->level);
	}
	...
	public function read($id)
	{
		...
		if ($row) {
			...
			$this->load->view('pegawai/pegawai_read', $data); // Menampilkan halaman detail pelanggan
	...
	public function create()
	{
		...
		$this->load->view('header', $dataAdm); // Menampilkan bagian header dan object data users 	 
		$this->load->view('pegawai/pegawai_form', $data); // Menampilkan halaman form pelanggan
		$this->load->view('footer'); // Menampilkan bagian footer
	}
	...
	public function update($id)
	{
		...
		if ($row) {
			...
			$this->load->view('header', $dataAdm); // Menampilkan bagian header dan object data users 
			$this->load->view('pegawai/pegawai_form', $data); // Menampilkan form pelanggan
			$this->load->view('footer'); // Menampilkan bagian footer
		}
		...
		// maka sistem akan melakukan update data pelanggan kedalam database
			...
			if (!empty($_FILES['photo']['name'])) {
				...
				if ($this->upload->do_upload('photo')) {
					...
					$this->Pegawai_model->update($this->input->post('id_pelanggan', TRUE), $data);
				}
