...
class Jadwal_model extends CI_Model
{
    ...
    function json() {		
        $this->datatables->select("id_jadwal, nama_jadwal, alamat_jadwal, telp_jadwal");
        $this->datatables->from('jadwal');        
        $this->datatables->add_column('action', anchor(site_url('jadwal/read/$1'),'<button type="button" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i></button>')."  ".anchor(site_url('jadwal/update/$1'),'<button type="button" class="btn btn-warning"><i class="fa fa-pencil" aria-hidden="true"></i></button>')."  ".anchor(site_url('jadwal/delete/$1'),'<button type="button" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_jadwal');
